...
const ROLE_OPTIONS = [
  { value: "PROFESOR", label: "Profesor", hint: "Poručuje kafu" },
  { value: "KUHINJA", label: "Kuhinja", hint: "Priprema kafu" },
];
    ...
    <form action={action} className="space-y-4">
      ...
      <fieldset>
        ...
        <div className="grid grid-cols-2 gap-2">
          {ROLE_OPTIONS.map((o) => (
            <label key={o.value}
              className="flex cursor-pointer flex-col rounded-lg border border-stone-300 p-3 has-checked:border-amber-700 has-checked:bg-amber-50">
